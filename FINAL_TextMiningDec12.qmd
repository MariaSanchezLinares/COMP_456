...
```{r, message=FALSE}
# Defining stop words 
stop_words <- c(stopwords("es"), "uno", "dos", "tres", "cuatro", "cinco", "seis", "siete", "ocho", "nueve", "diez", "enero", "febrero", "marzo", "abril", "mayo", "junio", "julio", "agosto", "septiembre", "octubre", "noviembre", "diciembre", "vs.", "a.m", "p.m", "vs", "copyright", "reservados", "page", "dijo", "según", "así", "ser", "diarios", "grupo")  
