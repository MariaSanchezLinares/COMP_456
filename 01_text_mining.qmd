...
```{r}
# maria's path
pdf_text_data <- pdf_text("../MEN Project/2023_el_tiempo/Alex Saab_ ¿qué viene para Venezuela y Estados Unidos tras su sorprendente liberación_.PDF")
...
```{r}
# Define PDF directory
el_espectador_pdf_directory_2020 <- "~/Desktop/MEN Project/2020_El_Expectador/"
...
```{r}
# Define PDF directory
el_tiempo_pdf_directory_2020 <- "~/Desktop/MEN Project/2020_El_Tiempo/"
...
```{r}
all_articles <- rbind(el_espectador_pdf_df_2017,  el_espectador_pdf_df_2023, el_tiempo_pdf_df_2017, el_tiempo_pdf_df_2023, el_tiempo_pdf_df_2020, el_espectador_pdf_df_2020)
