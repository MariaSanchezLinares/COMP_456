...
```{r}
# maria's path
pdf_text_data <- pdf_text("../MEN Project/2023_el_tiempo/Advertencia de EE. UU. a Venezuela _ 'sanciones volverán si no hay progreso pronto'.PDF")
...
el_tiempo_pdf_directory <- "../MEN Project/2023_el_tiempo/"
...
```{r}
# Define PDF directory
el_tiempo_pdf_directory_2017 <- "~/Desktop/MEN Project/2017_el_tiempo/"
...
```{r}
# Define PDF directory
el_espectador_pdf_directory_2017 <- "~/Desktop/MEN Project/2017_el_espectador/"
...
### el espectador 2021/2020
```{r}
# # Define PDF directory
# el_espectador_pdf_directory_2021 <- "~/Desktop/MEN Project/2021_el_espectador/"
# 
# # Get a list of all PDF files in the directory
# el_espectador_pdf_files_2021 <- dir_ls(el_espectador_pdf_directory_2021, glob = "*.PDF")
# 
# # Use purrr to apply the extraction function across all PDF files and combine results into one data frame
# el_espectador_pdf_df_2021 <- map_df(el_espectador_pdf_files_2021, extract_pdf_info)
...
```{r}
# # Define PDF directory
# el_tiempo_pdf_directory_2021 <- "~/Desktop/MEN Project/2021_el_tiempo/"
# 
# # Get a list of all PDF files in the directory
# el_tiempo_pdf_files_2021 <- dir_ls(el_tiempo_pdf_directory_2021, glob = "*.PDF")
# 
# # Use purrr to apply the extraction function across all PDF files and combine results into one data frame
# el_tiempo_pdf_df_2021 <- map_df(el_tiempo_pdf_files_2021, extract_pdf_info)
...
```{r}
all_articles <- rbind(el_espectador_pdf_df_2017,  el_espectador_pdf_df_2023, el_tiempo_pdf_df_2017, el_tiempo_pdf_df_2023)
