...
pdf_path <- "~/Desktop/MEN Project/2023_el_tiempo/Advertencia de EE. UU. a Venezuela _ 'sanciones volverán si no hay progreso pronto'.PDF"
pdf_dir <- "~/Desktop/MEN Project/2023_el_tiempo/"
...
preprocess_text <- function(text) {
  ...
  tokens <- tokens[!tokens %in% custom_stopwords]  # Remove English stop words
