...
y2023_pdf_directory <- "../articles_2023/"

# Get a list of all PDF files in the directory
y2023_pdf_files <- dir_ls(y2023_pdf_directory, glob = "*.PDF")

# Use purrr to apply the extraction function across all PDF files and combine results into one data frame
y2023_df <- map_df(y2023_pdf_files, extract_pdf_info)
...
```{r, message = FALSE}
# # Define PDF directory
# y2017_pdf_directory <- "../2017_el_espectador/"
# 
# # Get a list of all PDF files in the directory
# y2020_pdf_files <- dir_ls(y2017_pdf_directory, glob = "*.PDF")
# 
# # Use purrr to apply the extraction function across all PDF files and combine results into one data frame
# y2017_df <- map_df(y2020_pdf_files, extract_pdf_info)
...
```{r, message = FALSE}
# # Define PDF directory
# y2020_pdf_directory <- "./2020_el_tiempo/"
# 
# # Get a list of all PDF files in the directory
# y2020_pdf_files <- dir_ls(y2020_pdf_directory, glob = "*.PDF")
# 
# # Use purrr to apply the extraction function across all PDF files and combine results into one data frame
# y2020_df <- map_df(y2020_pdf_files, extract_pdf_info)
...
# processed_dts <- lapply(y2023_articles, preprocess_text, text_column = "content")
# 
...
y2023_articles <- preprocess_text(y2023_df, text_column = "content")

# export data
write.csv(y2023_articles, file = "~/Desktop/MEN Project/articles.csv")
